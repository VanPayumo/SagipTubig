...
<i class="fa fa-dashboard"></i> Dashboard / View Payments (Daily)
...
<i class="fa fa-money fa-fw"> </i> View Payments (Daily)
...
<?php
    ...
    $get_payments = "select * from payments where status='Paid' and YEAR(payment_date) = YEAR(NOW()) AND MONTH(payment_date) = MONTH(NOW()) AND DAY(payment_date) = DAY(NOW())";
